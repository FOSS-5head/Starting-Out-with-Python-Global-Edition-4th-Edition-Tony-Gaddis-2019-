# Эта программа использует аргумент side='left'
# в методе pack для изменения размещения элементов интерфейса.
...
class MyGUI:
    def __init__(self):
        ...
        self.__label1 = tkinter.Label(self.main_window,
                                      text='Привет, мир!')
        self.__label2 = tkinter.Label(self.main_window,
